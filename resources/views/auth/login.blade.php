            ...
            <div class="p-8 rounded-2xl bg-white shadow">
                ...
                <form id="loginForm" class="mt-12 space-y-6">
                    ...
                    <div class="flex flex-wrap items-center justify-between gap-4">
                        ...
                        <div class="text-sm">
                            <a href="javascript:void(0);" class="text-gray-900 hover:underline font-semibold">Forgot
                                your password?</a>
                        </div>
                    </div>
                    ...
                    <p class="text-slate-800 text-sm !mt-6 text-center">
                        ...
                        <a href="/register"
                            class="text-gray-900 hover:underline ml-1 whitespace-nowrap font-semibold">Register here</a>
                    </p>
                </form>
            </div>
        </div>
